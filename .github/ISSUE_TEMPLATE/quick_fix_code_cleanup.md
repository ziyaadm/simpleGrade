...
```
https://github.com/Learning-Fuze/sgt-react/compare/master...<COMPARE BRANCH>?assignees=thebearingedge&&expand=1&&template=quick_fix_code_cleanup.md&&labels=Technical%20Debt+Needs%20More%20Info&&title=[CLEANUP]%20QUICK-FIX%20-%20Insert%20Title%20Here
```
